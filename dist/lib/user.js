...
exports.unfollowUser = exports.editUser = exports.deleteUser = exports.followUser = exports.signOutAll = exports.signOut = exports.SignIn = exports.signUp = void 0;
...
const followUser = (currentUser, UserToFollowUnfollow) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (!currentUser.following.includes(user._id)) {
        (_a = user.followers) === null || _a === void 0 ? void 0 : _a.unshift(currentUser._id);
...
const unfollowUser = (currentUser, UserToFollowUnfollow) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const user = yield user_1.User.findById(UserToFollowUnfollow);
    if (!user)
        throw boom.notFound('User Not found');
    ...
    if (currentUser.following.includes(user._id)) {
        ...
        user.followers = (_b = user.followers) === null || _b === void 0 ? void 0 : _b.filter((id) => {
